    ...
    public class Program : NewPlugin
    {
        ...
        protected override async Task<bool> ProcessInternal()
        {
            ...
            else
            {
                ...
                Settings.Instance.CustomSettings.Add("IgnoreRequestUriRedirect", false); // special handling for CosmosDB [https://github.com/Azure/azure-libraries-for-net/issues/811]
